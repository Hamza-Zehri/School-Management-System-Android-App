...
class _SendState extends ConsumerState<_SendSmsTab> {
  ...
  Future<void> _send() async {
    ...
    if (!granted) { if (mounted) showSnack(context, 'SMS permission denied', isError: true); return; }
    ...
    if (targets.isEmpty) { showSnack(context, 'No students found', isError: true); setState(() => _sending = false); return; }
    ...
    if (!ok) { setState(() => _sending = false); return; }
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          const Text('Available placeholders: {student_name}, {class_name}, {section_name}, {date}, {due_amount}, {paid_amount}, {month_name}, {year}, {due_date}, {payment_date}, {custom_message}',
